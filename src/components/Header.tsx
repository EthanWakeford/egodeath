...
const Header: React.FC<HeaderProps> = ({ title, navs, cta }) => {
  ...
  return (
    <header
      className={`fixed top-0 z-50 flex w-screen justify-between px-4 py-2 text-center align-middle transition-all duration-1000 lg:grid lg:grid-cols-5 lg:px-0 lg:py-8 ${isScrolled ? 'bg-opacity-100' : 'bg-transparent dark:bg-transparent'} bg-ltbg1 dark:bg-black`}
    >
